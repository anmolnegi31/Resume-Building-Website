...
if ($result->num_rows > 0) {
    ...
    setcookie('college', $college, time() + 3600, '/');
    ...
    <div id="cv" class="instaFade">
        <div style="background: #ededed;"><a href="./download/download_template_3.php?id='.$id.'" class="download-button">Download</a></div>
        <div class="mainDetails">
            <div id="headshot" class="quickFade">
                <img src="../' . $row['photo'] . '" alt="Alan Smith" />
            </div>
