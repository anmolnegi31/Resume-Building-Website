...
<body>
    ...
    <div class="container">
        ...
        <form action="process_basic_details.php?details=<?php echo $details; ?>" method="POST">
            ...
            <span id="graduationYearError" class="error-message"></span>
...
<script>
    $(document).ready(function() {
        $('form').submit(function(event) {
            ...
            const graduationYear = $('#graduation_year').val().trim();
            if (graduationYear !== '') {
                if (!/^\d{4}$/.test(graduationYear)) {
                    $('#graduationYearError').text('Please enter a valid 4-digit Graduation Year');
